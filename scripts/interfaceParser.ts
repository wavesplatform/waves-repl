...
//     }
//     if (decl && decl.type) {
//         // tc.typeToString(decl.type)
//         const kind = (ts as any).SyntaxKind[decl.type.kind];
//         const kindName = (ts as any).ClassificationTypeNames[kind];
...
//
//
// console.log(JSON.stringify(out.IIssueTransaction, null, 4));
